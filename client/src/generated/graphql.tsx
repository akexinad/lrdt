...
export type PostSnippetFragment = (
  { __typename?: 'Post' }
  & Pick<Post, 'id' | 'title' | 'textSnippet' | 'creatorId' | 'createdAt' | 'updatedAt' | 'points' | 'voteStatus'>
  & { creator: (
    { __typename?: 'User' }
...
export type PostQuery = (
  ...
  & { post?: Maybe<(
    { __typename?: 'Post' }
    & Pick<Post, 'id' | 'updatedAt' | 'createdAt' | 'points' | 'title' | 'text'>
    & { creator: (
      { __typename?: 'User' }
      & Pick<User, 'id' | 'username'>
    ), upvotes?: Maybe<Array<(
...
export const UpdatePostDocument = gql`
    mutation UpdatePost($id: Int!, $options: UpdatePostInput!) {
